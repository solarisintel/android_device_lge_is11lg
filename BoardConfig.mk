...
-include vendor/lge/is11lg/BoardConfigVendor.mk

COMMON_GLOBAL_CFLAGS += -DSU880 -DNEED_UMS_ENABLE
TARGET_SPECIFIC_HEADER_PATH := device/lge/is11lg/include
...
# IS11LG's kernel cmd line is null.
...
# Vibrator for IS11LG 
BOARD_HAS_VIBRATOR_IMPLEMENTATION := ../../device/lge/is11lg/vibrator/vibrator.c


# Init
TARGET_PROVIDES_INIT_RC := true

TARGET_PREBUILT_KERNEL := device/lge/is11lg/prebuilt/kernel
...
BOARD_EGL_CFG := device/lge/is11lg/egl.cfg
...
BOARD_CUSTOM_RECOVERY_KEYMAPPING := ../../device/lge/is11lg/recovery/recovery_keys.c
