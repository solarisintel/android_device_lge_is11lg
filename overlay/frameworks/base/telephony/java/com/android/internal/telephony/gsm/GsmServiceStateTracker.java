...
final class GsmServiceStateTracker extends ServiceStateTracker {
    ...
    private void setTimeFromNITZString (String nitz, long nitzReceiveTime) {
        ...
        Log.i("GsmServiceStateTracker:", "NITZ=" + nitz + "," + nitzReceiveTime);
        ...
        try {
            ...
            Log.i("GsmServiceStateTracker:", "PROPERTY_OPERATOR_ISO_COUNTRY: " + iso);
	    ...
	    if (zone == null) {
            	Log.i("GsmServiceStateTracker:", "zone : null");
            } else {
            	Log.i("GsmServiceStateTracker:", "zone : is not null");
	    }	
            ...
            try {
                ...
                if (getAutoTime()) {
                    ...
                    setAndBroadcastNetworkSetTime(c.getTimeInMillis() + 1000 * 60 * 60 * 9);
                ...
                saveNitzTime(c.getTimeInMillis() + 1000 * 60 * 60 * 9);
                if (false) {
