...
public class CdmaServiceStateTracker extends ServiceStateTracker {
    ...
    */
    ...
    void setTimeFromNITZString (String nitz, long nitzReceiveTime)
    {
        ...
        Log.i("CdmaServiceStateTracker:", "NITZ=" + nitz + "," + nitzReceiveTime);
        ...
        try {
            ...
            Log.i("CdmaServiceStateTracker:", "PROPERTY_OPERATOR_ISO_COUNTRY: " + iso);
	    ...
	    if (zone == null) {
            	Log.i("CdmaServiceStateTracker:", "zone : null");
            } else {
            	Log.i("CdmaServiceStateTracker:", "zone : is not null");
	    }	
            ...
            try {
                ...
                if (getAutoTime()) {
                     ...
                     */
                    long gained = c.getTimeInMillis() + 1000 * 60 * 60 * 9 - System.currentTimeMillis();
                    ...
                    if ((mSavedAtTime == 0) || (timeSinceLastUpdate > nitzUpdateSpacing)
                        ...
                        setAndBroadcastNetworkSetTime(c.getTimeInMillis() + 1000 * 60 * 60 * 9); // set JST 
                ...
                SystemProperties.set("gsm.nitz.time", String.valueOf(c.getTimeInMillis() + 1000 * 60 * 60 * 9 ));
                mSavedTime = c.getTimeInMillis() + 1000 * 60 * 60 * 9;
